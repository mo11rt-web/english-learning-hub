...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen((o) => !o)}
        className="relative w-10 h-10 rounded-full bg-white/70 hover:bg-white flex items-center justify-center shadow-sm"
      ...
      {open && (
        <div className="absolute left-0 mt-2 w-80 max-h-96 overflow-y-auto bg-white/95 backdrop-blur-xl rounded-2xl shadow-glass border border-white/70 z-50">
            ...
            <div className="flex flex-col">
              {items.map((n) => (
                <button
                  ...
                  className="flex items-start gap-3 px-4 py-3 hover:bg-black/5 text-right border-b border-black/5 last:border-0"
                >
