    ...
    <AppShell requireRole="teacher">
      ...
      {pdfExportTarget && (
        <div style={{ position: "fixed", left: -99999, top: 0 }}>
          <div id="student-pdf-template" style={{ position: "relative", width: "794px", minHeight: "1123px", boxSizing: "border-box", padding: "45px 50px 35px", overflow: "hidden", background: "#ffffff", fontFamily: "Cairo, sans-serif", direction: "rtl", color: "#111827", border: "2px solid #556B4F", borderRadius: "12px" }}>
