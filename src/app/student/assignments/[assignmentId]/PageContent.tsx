...
import { apiFetch, apiUrl } from "@/lib/runtimeConfig";
...
export default function TakeAssignmentPage() {
  ...
  useEffect(() => {
    ...
    user.getIdToken()
      .then((token) => fetch(apiUrl(`/api/student/assignment-questions?assignmentId=${encodeURIComponent(assignmentId)}`), {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await apiFetch("/api/student/grade-assignment", {
        method: "POST",
        headers: {
